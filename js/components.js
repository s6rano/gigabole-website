            ...
            <div class="container mx-auto px-6 py-12">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><a href="${basePath}index.html" class="text-gray-600 hover:text-primary text-sm transition-colors">Accueil</a></li>
                            <li><a href="${basePath}catalogue/index.html" class="text-gray-600 hover:text-primary text-sm transition-colors">Catalogue</a></li>
                            <li><a href="${basePath}index.html#apropos" class="text-gray-600 hover:text-primary text-sm transition-colors">À propos</a></li>
                            <li><a href="${basePath}index.html#contact" class="text-gray-600 hover:text-primary text-sm transition-colors">Contact</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 class="font-sans text-sm font-semibold text-gray-900 mb-4 uppercase tracking-wide">
